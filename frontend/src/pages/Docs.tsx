  ...
  └─ Safe.execTransactionFromModule → funds move`}</CodeBlock>
          ...
          <Section title="Deployed contracts — Sepolia">
            ...
            <table className="w-full border-2 border-black mt-4 text-sm font-mono">
              ...
              <tbody>
                {[
                  ["PolicyRegistry", "0xf3812133f47cDEa7cfc11E75e0DeAdE149fD7650"],
                  ["NoxGuardModule", "0xa517298b74c058c7AC8c7614C3c84CC5f1b2a311"],
                  ["NoxRecipientProxy", "0xc8E18A3F8386D00A7095A49eABa0F1265f7dc3F0"],
...
NOX_RECIPIENT_PROXY=0xc8E18A3F8386D00A7095A49eABa0F1265f7dc3F0`}</CodeBlock>
            <p className="mt-4">
